...
(defun resultados (no-inicial profundidade-maxima algoritmo heuristica solucao tempo-inicial) "Função que imprime num ficheiro do tipo .DAT as estatisticas do jogo."
	...
	;; Esta parte será escrita no ficheiro do tipo .DAT
		...
		(format ficheiro "~%Profundidade m�xima ~s ~%" profundidade-maxima)
		(format ficheiro "~%Algoritmo: ~s ~%" algoritmo)
		(format ficheiro " ~s ~%" heuristica)
		(format ficheiro "~%Profundidade: ~s ~%" profundidade)
		(format ficheiro "~%N�s Gerados: ~s ~%" nos-gerados)
		(format ficheiro "~%N�s expandidos: ~s ~%" tamanho-lista-fechados)
		(format ficheiro "~%Penetr�ncia: ~a ~%"  (penetrancia no-final nos-gerados)); (float (/ (second (car abertos))(+ (length abertos) (length fechados)))))
		(format ficheiro "~%Fator de Ramifica��o ~%" (fator-ramificacao profundidade nos-gerados))
		;(format ficheiro "~%Solução: ~s ~%" solucao)	
		(format ficheiro "~%Caminho at� � solu��o: ~s ~%" caminho)	
	...
	;;Esta parte será mostrada na consola
		...
		(format t "~%Profundidade m�xima ~s ~%" profundidade-maxima)
		(format t "~%Algoritmo: ~s ~%" algoritmo)
		(format t "~%Heuristica: ~s ~%" heuristica)
		(format t "~%Profundidade: ~s ~%" profundidade)
		(format t "~%N�s Gerados: ~s ~%" nos-gerados)
		(format t "~%N�s expandidos: ~s ~%" tamanho-lista-fechados)
		(format t "~%Penetr�ncia: ~a ~%" (penetrancia no-final nos-gerados)) ;(float (/ (second (car abertos))(+ (length abertos) (length fechados)))))
		(format t "~%Fator de Ramifica��o ~%" (fator-ramificacao profundidade nos-gerados))	
		;(format t "~%Solução: ~s ~%" solucao)	
		(format t "~%Caminho at� � solu��o:: ~s ~%" caminho)	
...
#|
(length (get-no-pai (get-no-estado '(((((NIL NIL NIL) (NIL T T) (NIL T T) (NIL NIL T)) ((NIL NIL NIL) (NIL T NIL) (NIL T T) (NIL T T))) 2 NIL ((((NIL NIL NIL) (NIL NIL T) (NIL T T) (NIL NIL T)) ((NIL NIL NIL) (NIL T NIL) (NIL T T) (NIL T T))) 1 NIL ((((NIL NIL NIL) (NIL NIL T) (NIL T T) (NIL NIL T)) ((NIL NIL NIL) (NIL T NIL) (NIL NIL T) (NIL T T))) 0 NIL NIL))) 0) )))
->4
|#
