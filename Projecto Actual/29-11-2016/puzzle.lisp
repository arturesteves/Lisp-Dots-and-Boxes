...
(defun no-teste ()
"Tabuleiro=tabuleiro-teste ; profundidade=0; heuristica=0; pai=nil"
...
;; Teste: (inserir-arco-vertical 1 3 (tabuleiro-teste))	   -> (((NIL T T) (NIL NIL NIL) (NIL NIL NIL) (NIL NIL NIL)) ((NIL NIL T) (T T T) (NIL NIL NIL) (NIL T NIL)))
;; Teste: (inserir-arco-vertical 2 3 (tabuleiro-teste))    -> NIL
...
;;Teste:  (possivel-adicionar-arco-aux 2 '(NIL T NIL NIL))	 ->Resultado: NIL
